...
Los dos métodos utilizados en este estudio permitieron resolver el problema de localización planteado. El método Orloca considera la distancia mínima para determinar la localización óptima, mientras que el AHP emplea una valoración subjetiva para priorizar las distintas alternativas de decisión. En ambos casos se llegó a la misma localización
